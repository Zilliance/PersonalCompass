...
final class LeftMenuViewController: UIViewController {
    ...
    var showingCompass: Bool {
        guard let currentNavigation = self.sideMenuController?.centerViewController as? UINavigationController, currentNavigation.viewControllers.first is StartCompassViewController else {
            return false
        }
    ...
    func showCompassView() {
        ...
        guard !self.showingCompass else {
